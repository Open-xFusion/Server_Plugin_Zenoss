...
class TestUtils(unittest.TestCase):
    ...
    def testversionstringsplit(self):
        ...
        LOG.info(ubootversion, cpldversion, fpgaversion, softwareversion)
    ...
    def testipstringsplit(self):
        ...
        LOG.info(bnip, bnipmask)
        self.assertEqual(bnip, '172.180.0.211', '')

    def teststringsplit(self):
        strs = 'hwOEMEvent    XFUSION OEM event    2    1.3.6.1.4.1.58132.2.235.1.1.500.10.1.1'
