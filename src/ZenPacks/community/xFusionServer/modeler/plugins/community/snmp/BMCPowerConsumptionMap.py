...
class BMCPowerConsumptionMap(SnmpPlugin):
    ...
    snmpGetMap = GetMap({
        '.1.3.6.1.4.1.58132.2.235.1.1.1.13.0': 'presentSystemPower',
        '.1.3.6.1.4.1.58132.2.235.1.1.20.1.0': 'peakPower',
        '.1.3.6.1.4.1.58132.2.235.1.1.20.3.0': 'averagePower',
        '.1.3.6.1.4.1.58132.2.235.1.1.20.4.0': 'powerConsumption',
        '.1.3.6.1.4.1.58132.2.235.1.1.23.1.0': 'powerCappingEnable',
        '.1.3.6.1.4.1.58132.2.235.1.1.23.2.0': 'powerCappingValue',
        '.1.3.6.1.4.1.58132.2.235.1.1.23.3.0': 'powerCappingFailureAction',
        })
