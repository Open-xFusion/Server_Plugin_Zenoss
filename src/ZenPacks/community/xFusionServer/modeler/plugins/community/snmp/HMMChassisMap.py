...
class HMMChassisMap(SnmpPlugin):
    ...
    snmpGetMap = GetMap({
        '.1.3.6.1.4.1.58132.2.82.1.82.2.4.0': 'shelfLocation',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.5.0': 'shelfHealth',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.8.0': 'shelfChassisID',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.13.0': 'shelfRealTimePower',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.14.0': 'shelfPowerCappingEnable',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.15.0': 'shelfPowerCapping',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.18.0': 'shelfChassisName',
        '.1.3.6.1.4.1.58132.2.82.1.82.2.2001.1.16.0': 'shelfType',
        })
