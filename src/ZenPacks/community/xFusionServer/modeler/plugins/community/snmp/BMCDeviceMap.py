...
class BMCDeviceMap(SnmpPlugin):
    ...
    snmpGetTableMap = (
        GetTableMap(
            'fruBoardTable', '1.3.6.1.4.1.58132.2.235.1.1.19.50.1', {
                '.1': 'fruId',
    ...
    snmpGetMap = GetMap({
        '.1.3.6.1.4.1.58132.2.235.1.1.19.50.1.4.1': 'fruBoardSerialNumber',
        '.1.3.6.1.4.1.58132.2.235.1.1.1.6.0': 'deviceName',
        '.1.3.6.1.4.1.58132.2.235.1.1.1.9.0': 'hostName',
        '.1.3.6.1.4.1.58132.2.235.1.1.1.2.0': 'systemBootsequence',
        '.1.3.6.1.4.1.58132.2.235.1.1.1.12.0': 'fruPowerControl',
        '.1.3.6.1.4.1.58132.2.235.1.1.10.50.1.4.9.77.97.105.110.98.111.97.114.100': 'boardId',
    })
